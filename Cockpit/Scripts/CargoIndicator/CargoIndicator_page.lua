...
NarrowCircle.controllers    = {{"narrowPosition",aspect-box_width,1.0-box_height}}
...
circle.controllers    = {{"circlePosition",aspect-box_width,1.0-box_height}--[[,{"radius"}--]]}
...
heightBordersCargo	.controllers    = {{"showHeightBordersCargo"}}
...
heightBordersZone	.controllers    = {{"showHeightBordersZone"}}
...
zone.element_params = {"SHOW_CONTROLS"} 
zone.controllers    = {{"parameter_in_range", 0, 1}}
...
heightnarrow.controllers    = {{"heightStripPosition",aspect-0.06,1.0-box_height}}
