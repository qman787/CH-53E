...
local font7segment    = MakeFont({used_DXUnicodeFontData = "font7segment"},{0,255,0,215})
local center={0.032, 0.01, 0.00}  --- {L/R,U/D,forward/back}
...
base.init_pos		 = {0.0, 0.0, 0.0}  -- center   
...
GMT_sec.material        = font7segment
GMT_sec.init_pos        = {center[1]+.01,center[2]-0.005,center[3]}
GMT_sec.alignment       = "LeftTop"   --"LeftBottom"
GMT_sec.stringdefs      = {0.007,0.75*0.007, 0, 0} --{0.012,0.75 * 0.012, 0, 0}  -- {size vertical, horizontal, 0, 0}
...
LT_hours.material        = font7segment
LT_hours.init_pos        = {center[1]-.01,center[2]-0.005,center[3]}		
LT_hours.alignment       = "RightTop"
LT_hours.stringdefs      = {0.007,0.75*0.007, 0, 0} --{0.012,0.75 * 0.012, 0, 0}  -- {size vertical, horizontal, 0, 0}
...
LT_mins.material        = font7segment
LT_mins.init_pos        = {center[1],center[2]-0.005,center[3]}	 
LT_mins.alignment       = "CenterTop"
LT_mins.stringdefs      = {0.007,0.75*0.007, 0, 0} --{0.012,0.75 * 0.012, 0, 0}  -- {size vertical, horizontal, 0, 0}
