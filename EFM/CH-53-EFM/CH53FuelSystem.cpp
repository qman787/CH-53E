...
namespace CH53
{
    ...
    void FuelSystem::vSimulate(struct Systems& systems, EDPARAM& cockpitAPI, double dt)
    {
        ...
        if (capacityTotal_LBS > 0)
        {
            ...
            //void* hFuelQuantityTotalLBS = cockpitAPI.getParamHandle("FUEL_TOTAL_LBS");
            //if (hFuelQuantityTotalLBS != nullptr)
            //{
            //    cockpitAPI.setParamValue(hFuelQuantityTotalLBS, quantityTotal_LBS);
            //}
            //void* hFuelQuantityTotalPCT = cockpitAPI.getParamHandle("FUEL_TOTAL_PCT");
            //if (hFuelQuantityTotalPCT != nullptr)
            //{
            //    cockpitAPI.setParamValue(hFuelQuantityTotalPCT, quantityTotal_PCT);
            //}

            //void* hFuelFuselage1C = cockpitAPI.getParamHandle("FUEL_FUSELAGE_1C");
            //if (hFuelFuselage1C != nullptr)
            //{
            //    cockpitAPI.setParamValue(hFuelFuselage1C, FuelSystem::fuelTanks[FuelSystem::FUEL_FUSELAGE_1C].quantity_LBS);
            //}
            //void* hFuelFuselage1C_PCT = cockpitAPI.getParamHandle("FUEL_FUSELAGE_1C_PCT");
            //if (hFuelFuselage1C_PCT != nullptr)
            //{
            //    cockpitAPI.setParamValue(hFuelFuselage1C_PCT, FuelSystem::fuelTanks[FuelSystem::FUEL_FUSELAGE_1C].quantity_PCT);
            //}
            //void* hFuelFuselage2L = cockpitAPI.getParamHandle("FUEL_TANK_NO_2_LEFT");
            //if (hFuelFuselage2L != nullptr)
            //{
            //    cockpitAPI.setParamValue(hFuelFuselage2L, FuelSystem::fuelTanks[FuelSystem::FUEL_TANK_NO_2_LEFT].quantity_LBS);
            //}
            //void* hFuelFuselage2R = cockpitAPI.getParamHandle("FUEL_TANK_NO_2_RIGHT");
            //if (hFuelFuselage2R != nullptr)
            //{
            //    cockpitAPI.setParamValue(hFuelFuselage2R, FuelSystem::fuelTanks[FuelSystem::FUEL_TANK_NO_2_RIGHT].quantity_LBS);
            //}
            //void* hFuelFuselage3L = cockpitAPI.getParamHandle("FUEL_FUSELAGE_3L");
            //if (hFuelFuselage3L != nullptr)
            //{
            //    cockpitAPI.setParamValue(hFuelFuselage3L, FuelSystem::fuelTanks[FuelSystem::FUEL_FUSELAGE_3L].quantity_LBS);
            //}
            //void* hFuelFuselage3R = cockpitAPI.getParamHandle("FUEL_FUSELAGE_3R");
            //if (hFuelFuselage3R != nullptr)
            //{
            //    cockpitAPI.setParamValue(hFuelFuselage3R, FuelSystem::fuelTanks[FuelSystem::FUEL_FUSELAGE_3R].quantity_LBS);
            //}
            //void* hFuelFuselage4L = cockpitAPI.getParamHandle("FUEL_FUSELAGE_4L");
            //if (hFuelFuselage4L != nullptr)
            //{
            //    cockpitAPI.setParamValue(hFuelFuselage4L, FuelSystem::fuelTanks[FuelSystem::FUEL_FUSELAGE_4L].quantity_LBS);
            //}
            //void* hFuelFuselage4R = cockpitAPI.getParamHandle("FUEL_FUSELAGE_4R");
            //if (hFuelFuselage4R != nullptr)
            //{
            //    cockpitAPI.setParamValue(hFuelFuselage4R, FuelSystem::fuelTanks[FuelSystem::FUEL_FUSELAGE_4R].quantity_LBS);
            //}
            //void* hFuelFuselage5L = cockpitAPI.getParamHandle("FUEL_TANK_NO_1");
            //if (hFuelFuselage5L != nullptr)
            //{
            //    cockpitAPI.setParamValue(hFuelFuselage5L, FuelSystem::fuelTanks[FuelSystem::FUEL_TANK_NO_1].quantity_LBS);
            //}
            //void* hFuelFuselage5R = cockpitAPI.getParamHandle("FUEL_TANK_NO_3");
            //if (hFuelFuselage5R != nullptr)
            //{
            //    cockpitAPI.setParamValue(hFuelFuselage5R, FuelSystem::fuelTanks[FuelSystem::FUEL_TANK_NO_3].quantity_LBS);
            //}
            //void* hFuelWingL = cockpitAPI.getParamHandle("FUEL_TANK_AUX_LEFT");
            //if (hFuelWingL != nullptr)
            //{
            //    cockpitAPI.setParamValue(hFuelWingL, FuelSystem::fuelTanks[FuelSystem::FUEL_TANK_AUX_LEFT].quantity_LBS);
            //}
            //void* hFuelWingR = cockpitAPI.getParamHandle("FUEL_TANK_AUX_RIGHT");
            //if (hFuelWingR != nullptr)
            //{
            //    cockpitAPI.setParamValue(hFuelWingR, FuelSystem::fuelTanks[FuelSystem::FUEL_TANK_AUX_RIGHT].quantity_LBS);
            //}
        }
    }
}
