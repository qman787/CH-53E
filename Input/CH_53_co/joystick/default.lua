...
-- Countermeasures
	...
	{down =  Keys.PlanePilotDoor,					name = _('Toggle Open/Close Pilot Door'),			category = _('Systems')},	
	{down =  Keys.PlanePilotDoor,					name = _('Toggle Open/Close Gunner Door'),			category = _('Systems')},	
