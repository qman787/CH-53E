...
-- Systems
	...
	{combos = {{key = 'C',	 reformers = {'LShift'}}}, down = Keys.PlaneCargoDoorLeft,	 name = _('Toggle Open/Close Cargo Left Door'), category = _('General')},
	{combos = {{key = 'C',	 reformers = {'RShift'}}}, down = Keys.PlaneCargoDoorRight,	 name = _('Toggle Open/Close Cargo Right Door'), category = _('General')},

	{combos = {{key = 'G'}}, down = Keys.PlaneGear,	 name = _('LandingGear Up/Down'), category = _('General')},
	{combos = {{key = 'F',  reformers = {'LShift'}}}, down = Keys.RefuelProbe,	 name = _('Refuel Probe In/Out'), category = _('General')},
	{combos = {{key = 'R',  reformers = {'LWin'}}}, down = Keys.Ramp,	 name = _('Ramp Open/Close'), category = _('General')},

	
	
-- Sensors Extra
{combos = {{key = 'O', reformers = {'LShift'}}}, down = iCommandPlaneLaserRangerOnOff, name = _('Laser Ranger On/Off'), category = _('Sensors')},
...
{combos = {{key = 'R', 	reformers = {'LAlt'}}}, down = Keys.RWR,	 name = _('RWR On/Off'), category = _('Sensors')},
{combos = {{key = 'R', 	reformers = {'LShift'}}}, down = Keys.RWRknob,	 name = _('RWRBrightness'), category = _('Sensors')},


{combos = {{key = 'Z'}}, up = 10100, pressed = 10101, name = _('Brake'), category = _('Systems')},
{combos = {{key = 'W'}}, up = 10014, pressed = 10012, name = _('Plane Left Rudder Start'), category = _('Systems')},
{combos = {{key = 'X'}}, up = 10015, pressed = 10013, name = _('Plane Right Rudder Start'), category = _('Systems')},

{combos = {{key = 'W', reformers = {'LCtrl'}}}, down = Keys.WinchDown, name = _('Winch Up-Down'), category = _('General')},
{combos = {{key = 'W', reformers = {'LAlt'}}}, down = Keys.WinchUp, name = _('Winch Up'), category = _('General')},
{combos = {{key = 'T', reformers = {'LAlt'}}}, down = Keys.Opentail, name = _('Open Tail'), category = _('General')},
{combos = {{key = 'W', reformers = {'LWin'}}}, down = Keys.Winchpower, name = _('Winch Power On/Off'), category = _('General')},
{combos = {{key = 'Q', reformers = {'LAlt'}}}, down = Keys.Wipersonoff, name = _('Wipers On/Off'), category = _('General')},


-- Gun turret
--{combos = {{key = 'C'}}, down = Keys.SelectCannon,						name = _('Select Gun'),				 category = _('Weapons')},
{combos = {{key = ';'}}, pressed = Keys.GunturretUp, name = _('Target Turret Up'), category = _('Weapons')},
{combos = {{key = '.'}}, pressed = Keys.GunturretDown, name = _('Target Turret Down'), category = _('Weapons')},
{combos = {{key = ','}}, pressed = Keys.GunturretLeft, name = _('Target Turret Left'), category = _('Weapons')},
{combos = {{key = '/'}}, pressed = Keys.GunturretRight, name = _('Target Turret Right'), category = _('Weapons')},
{combos = {{key = '*'}}, pressed = Keys.GunturretReset, name = _('Target Turret Reset'), category = _('Weapons')},
{combos = {{key = 'U'}},  down = Keys.GunturretUncage, name = _('Target Turret uncage'), category = _('Weapons')},

{combos = {{key = 'H'}}, down = 1507, name = _('Helmet Mount Display'), category = _('Systems')},
...
-- Countermeasures
	{combos = {{key = 'Delete'}}, down = Keys.PlaneDropFlareOnce,		name = _('Countermeasures Flares Dispense'),						category = _('Countermeasures') , features = {"Countermeasures"}},
	{combos = {{key = 'Insert'}}, down = Keys.PlaneDropChaffOnce,		name = _('Countermeasures Chaff Dispense'),							category = _('Countermeasures') , features = {"Countermeasures"}},
...
-- Lighting
	...
	{combos = {{key = 'L', reformers = {'RCtrl'}}} , down = Keys.PlaneLightsOnOff, name  =  _('PlaneLights On/Off'), category = _('Lighting')},
	{combos = {{key = 'L', reformers = {'RAlt'}}}  , down = Keys.PositionLights, name  = _('Position Lights'), category = _('Lighting')},
	{combos = {{key = 'L', reformers = {'LShift'}}}  , down = Keys.BladetipOnOff, name  = _('Blade tip lights'), category = _('Lighting')},
...
-- Multicrew
	...
	{combos = {{key = '3'}},	down = iCommandViewCockpitChangeSeat, value_down = 3, name = _('Occupy Right Gunnner Seat'),	category = _('Crew Control')},	
	{combos = {{key = '4'}},	down = iCommandViewCockpitChangeSeat, value_down = 4, name = _('Occupy Left Gunnner Seat'),	category = _('Crew Control')},	
...
----------------------------------- from common_keyboard_binding.lua   ------------------------------------------------------------
    ...
    -- Collective
	{combos = {{key = 'Num+'}}, pressed = EFM_commands.collectiveIncrease, 	name = _('Collective Increase'), category = _('Flight Controls')},
	{combos = {{key = 'Num-'}}, pressed = EFM_commands.collectiveDecrease, 	name = _('Collective Decrease'), category = _('Flight Controls')},
},
