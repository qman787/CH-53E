...
-- Lighting
	...
	{combos = {{key = 'L', reformers = {'RAlt'}}}  , down = Keys.PlaneAntiCollisionLights , name  = _('Light anti-collision'), category = _('Lighting')},
	
{combos = {{key = 'J', reformers = {'RCtrl'}}},   down =  Keys.PlaneRotorTipLights, name = _('Lights rotor tip'), category = _('Ins Wall panel')},
{combos = {{key = 'J', reformers = {'RAlt'}}},  down =   Keys.PlaneFormationLights , name  =  _('Lights formation 10\%/30\%/100\%/Off'), category = _('Ins Wall panel')},
