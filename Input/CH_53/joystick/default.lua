...
-- Systems
	...
	{down = Keys.PlaneGearUp, name = _('LandingGear Up'), category = _('Systems')}, 
	{down = Keys.PlaneGearDown, name = _('LandingGear Down'), category = _('Systems')}, 
	{down = Keys.PlaneGear, name = _('LandingGear Up/Down'), category = _('Systems')}, 
    ...
    {pressed = EFM_commands.pidIUp, name = _('PID I Up'), category = _('Systems')},
    {pressed = EFM_commands.pidIDown, name = _('PID I Down'), category = _('Systems')},
    {pressed = EFM_commands.pidDUp, name = _('PID D Up'), category = _('Systems')},
    {pressed = EFM_commands.pidDDown, name = _('PID D Down'), category = _('Systems')},
    {pressed = EFM_commands.pidTimeUp, name = _('PID Time Up'), category = _('Systems')},
    {pressed = EFM_commands.pidTimeDown, name = _('PID Time Down'), category = _('Systems')},


-- Autopilot
    {pressed = EFM_commands.autopilotOff, name = _('Autopilot OFF'), category = _('Autopilot')},
    {pressed = EFM_commands.autopilotAFCS, name = _('AFCS toggle'), category = _('Autopilot')},
    {pressed = EFM_commands.autopilotRADALT, name = _('RadAlt Hold'), category = _('Autopilot')},
    {pressed = EFM_commands.autopilotBARALT, name = _('BarAlt Hold'), category = _('Autopilot')},
    {pressed = EFM_commands.autopilotHDGHOLD, name = _('Hdg Hold'), category = _('Autopilot')},
    {pressed = EFM_commands.autopilotBANKHOLD, name = _('Bank Hold'), category = _('Autopilot')},
    {pressed = EFM_commands.autopilotSPEEDHOLD, name = _('Speed Hold'), category = _('Autopilot')},

    {pressed = EFM_commands.autopilotRADALT_INC, name = _('RadAlt Inc'), category = _('Autopilot')},
    {pressed = EFM_commands.autopilotRADALT_DEC, name = _('RadAlt Dec'), category = _('Autopilot')},
    {pressed = EFM_commands.autopilotBARALT_INC, name = _('BarAlt Inc'), category = _('Autopilot')},
...
{ pressed = Keys.GunturretLeft, name = _('Target Turret Left'), category = _('Weapons')},
{ pressed = Keys.GunturretRight, name = _('Target Turret Right'), category = _('Weapons')},
{ pressed = Keys.GunturretReset, name = _('Target Turret Reset'), category = _('Weapons')},
{ pressed = Keys.GunturretUncage, name = _('Target Turret uncage'), category = _('Weapons')},


-- Weapons                                                                        
    {pressed = Keys.TriggerFireOn, up = Keys.TriggerFireOff, name = _('Gun Fire'), category = _('Weapons')},
	{down = Keys.GunSelector, name = _('Gun Selector'), category = _('Weapons')},
...
-- Countermeasures
	{ down = Keys.PlaneDropFlareOnce,		name = _('Countermeasures Flares Dispense'),						category = _('Countermeasures') , features = {"Countermeasures"}},
	{ down = Keys.PlaneDropChaffOnce,		name = _('Countermeasures Chaff Dispense'),							category = _('Countermeasures') , features = {"Countermeasures"}},
	
	{down =  Keys.PlanePilotDoor, name = _('Toggle Open/Close Pilot Door'),			category = _('General')},	
	{down =  Keys.PlanecoPilotDoor, name = _('Toggle Open/Close coPilot Door'),			category = _('General')},	
	{down =  Keys.PlaneCargoDoorLeft, name = _('Toggle Open/Close Cargo Left Door'),			category = _('General')},	
	{down =  Keys.PlaneCargoDoorRight, name = _('Toggle Open/Close Cargo Right Door'),			category = _('General')},	

-- Lighting
    {down = Keys.LandingLight, name = _('Landing Light'),	category = _('Lighting')},
	{down = Keys.PlaneLightsOnOff , name  =  _('PlaneLights On/Off'), category = _('Lighting')},
	{down = Keys.PlaneAntiCollisionLights , name  = _('Light anti-collision'), category = _('Lighting')},
