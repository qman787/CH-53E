...
left_gunner_position =  {
	...
	FOV = { 
		azimuth = {math.rad(-130), math.rad(-30.0)},
...
left_g_states = fill_side_states(43, {426,2}, {423,2}, {424,2}, {452,2},{52,2},52)
...
right_gunner_position =  {
	...
	--Field of view related to aircraft
	FOV = { 
		azimuth = {math.rad(30), math.rad(130.0)},
		elevation = {math.rad(-40), math.rad(10.0)}
	}
}
...
right_g_states = fill_side_states(44,{426,3}, {423,3}, {424,3}, {452,3}, {52,3},51)
